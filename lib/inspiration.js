...
export const LEVELS = [
  ...
  { level: 2, name: '访客',   minPoints: 100,  unlocks: ['收藏', '关注'] },
  { level: 3, name: '学徒',   minPoints: 300,  unlocks: ['讨论', '收藏夹'] },
  { level: 4, name: '画友',   minPoints: 600,  unlocks: ['长评', '参加活动'] },
  { level: 5, name: '鉴赏者', minPoints: 1200, unlocks: ['打分', '推荐', '摇摇打赏'] },
  { level: 6, name: '创作者', minPoints: 2000, unlocks: ['🎨 发布作品'] },
  { level: 7, name: '徽者',   minPoints: 3500, unlocks: ['🏅 徽章系统'] },
  { level: 8, name: '知音',   minPoints: 5500, unlocks: ['🪞 平行之魂'] },
  { level: 9, name: '造物者', minPoints: 8000, unlocks: ['🏛️ 办展能力'] },
]
