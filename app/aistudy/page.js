...
// 信息技术基础互动课堂（cradle.art/aistudy）：四个任务的滚动叙事式交互课件。
...
<header class="bar" id="bar">
  <div class="bar-in">
    <div class="logo"><b>AISTUDY</b> · 信息技术基础</div>
...
/* boot */
(function(){const hs=(location.hash||'').slice(1);showChapter(ORDER.includes(hs)?hs:store.get('tab','t1'),false)})();
