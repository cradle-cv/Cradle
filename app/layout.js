...
export const metadata = {
  ...
  title: {
    default: "Cradle 摇篮 · 慢的、自在的艺术社区",
    template: "%s · Cradle 摇篮",
  },
  description: "Cradle 摇篮是一个慢的、自在的艺术社区：艺术阅览室带你读懂大师经典，每日一展呈现当代创作，杂志社与艺术家专栏深入创作者的世界，汇聚原创艺术家的作品集与展览。",
  ...
  openGraph: {
    ...
    siteName: "Cradle 摇篮",
    title: "Cradle 摇篮 · 慢的、自在的艺术社区",
    description: "艺术阅览室 · 每日一展 · 杂志社 · 艺术家专栏。一个慢的、自在的艺术社区。",
    locale: "zh_CN",
              ...
              "@graph": [
                {
                  ...
                  description: "一个慢的、自在的艺术社区，汇聚艺术阅览室、每日一展、杂志社、艺术家专栏与原创艺术家的作品。",
                },
                {
                  "@type": "WebSite",
