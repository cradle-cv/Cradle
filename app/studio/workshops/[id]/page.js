...
// 艺术家只能存草稿或提交待审；放行与截止由编辑部决定
const STATUS_OPTIONS = [
  { key: 'draft', label: '存为草稿', hint: '只有自己看得到' },
  { key: 'pending', label: '提交待审', hint: '交给编辑部放行' },
]
    ...
    <div>
      ...
      <div className="space-y-6 max-w-3xl">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-sm text-gray-500 mb-4">摇篮不经手收款，请你直接与报名的人联系。这份名单只有你和编辑部看得到。</p>
        ...
        <div className="flex justify-end gap-3 pb-10">
          <Link href="/studio?tab=workshops"
